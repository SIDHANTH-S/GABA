...
export function CheckpointModal() {
  ...
  const riskKey = (payload.riskLevel || 'low') as keyof typeof riskColors;
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className={`w-full max-w-md bg-[#111111] border ${riskColors[riskKey] || riskColors.low} rounded-xl p-6 shadow-2xl`}>
